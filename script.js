var que=1, rtclick=0, wgclick=0, i=0, op, timetaken=0, kbcaudio=0, audio1=0;
	...
	function showResult() {
		...
		board=`<form style="border: 2px solid white; opacity: 0.3; background: black; margin-top: 20%">
    			...
    			<a style="opacity:1;border: 0.5px solid gold;border-radius:10px; outline: none;text-decoration: none; padding: 6px; background:transparent; " href= "whatsapp://send?text=I enjoyed🤩🤩 playing this amazing KBC game💖💖 https://rockstartushar.github.io/doon-geeta-kbc.github.io/ ..check your knowledge🤷‍♂🤔🤔..click the link🙏🙏 & have fun😉 https://rockstartushar.github.io/doon-geeta-kbc.github.io/" data-action="share/whatsapp/share" target="_blank"> Share to whatsapp!!</a>
    			<center>
    			</div>
    			</form><br>`;
